...
"There are no Chat Backends enabled." => "Etkin sohbet bağlantısı yok.",
"In order to chat please enable at least one Chat backend." => "Sohbeti sıralamak için lütfen en az bir sohbet bağlantısı açın.",
"With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." => "Diğer ownCloud kullanıcıları ile 'OCH' bağlantısı için yapar. Bunun çalışması için yapılandırmaya gerek yoktur.",
