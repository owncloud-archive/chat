OC.L10N.register(
    ...
    "Start a chat with ..." : "Iniciar uma conversação com...",
    "Search in conversations" : "Procurar nas conversações",
    "Add Person" : "Adicionar Pessoa",
    "View Attached files" : "Ver ficheiros Anexados",
    "Chat Message" : "Mensagem de Conversação",
    ...
    "There are no Chat Backends enabled." : "Não existem Interfaces de Conversação activadas.",
    "In order to chat please enable at least one Chat backend." : "Para poder conversar, por favor, active pelo menos uma interface de Conversação.",
