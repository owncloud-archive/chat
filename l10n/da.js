OC.L10N.register(
    ...
    "There are no Chat Backends enabled." : "Der er ikke slået chat-bagsider'er til.",
    "In order to chat please enable at least one Chat backend." : "For at chatte, så skal der mindst være slået én chat-bagsider til.",
    "With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." : "Med \"OCH\"-bagsiden'en kan du chatte med andre ownCloud-brugere. Den fungerer uden konfiguration.",
    "It can be enabled by running the following command in the root of your ownCloud installation:" : "Den kan slås til ved at afvikle følgende kommando i roden af din ownCloud-installation:",
