...
!function(a) {
    ...
    var e = a.module("bernhardposselt.enhancetext", [ "ngSanitize" ]).provider("enhanceTextFilter", function() {
        var b = {
            cache: !0,
            newLineToBr: !0,
            embedLinks: !0,
        ...
        this.setOptions = function(c) {
            a.extend(b, c);
        }, this.$get = [ "$sce", "TextEnhancer", function(d, e) {
            return function(f) {
                var g = f;
                if (b.cache) {
                    var h = c[f];
                    if (a.isDefined(h)) return h;
                }
                return f = e(f, b), f = d.trustAsHtml(f), b.cache && (c[g] = f), f;
            };
        } ], this.$get.$inject = [ "$sce", "TextEnhancer" ];
    });
    e.factory("TextEnhancer", [ "SmileyEnhancer", "VideoEnhancer", "NewLineEnhancer", "ImageEnhancer", "YouTubeEnhancer", "LinkEnhancer", function(a, c, d, e, f, g) {
        return function(h, i) {
            return h = b(h), h = a(h, i.smilies), i.embedImages && (h = e(h, i.embeddedImagesHeight, i.embeddedVideosWidth, i.embeddedLinkTarget)), 
            i.embedVideos && (h = c(h, i.embeddedImagesHeight, i.embeddedVideosWidth)), i.embedYoutube && (h = f(h, i.embeddedYoutubeHeight, i.embeddedYoutubeWidth)), 
            i.newLineToBr && (h = d(h)), i.embedLinks && (h = g(h, i.embeddedLinkTarget)), h;
        };
    } ]), e.factory("ImageEnhancer", function() {
        return function(a, b, c, e) {
            void 0 === e && (e = "_blank");
            var f = /((?:https?):\/\/\S*\.(?:gif|jpg|jpeg|tiff|png|svg|webp))/gi, g = d(b, c), h = '<a href="$1" target="' + e + '"><img ' + g + 'alt="image" src="$1"/></a>';
            return a.replace(f, h);
        };
    }), e.factory("LinkEnhancer", function() {
        return function(a, b) {
            void 0 === b && (b = "_blank");
            var c = /((href|src)=["']|)(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi;
            return a.replace(c, function() {
                return arguments[1] ? arguments[0] : '<a target="' + b + '" href="' + arguments[3] + '">' + arguments[3] + "</a>";
            });
        };
    }), e.factory("NewLineEnhancer", function() {
        return function(a) {
            return a.replace(/\n/g, "<br/>").replace(/&#10;/g, "<br/>");
        };
    }), e.factory("SmileyEnhancer", function() {
        return function(a, b) {
            for (var d = Object.keys(b), e = a.split("\n"), f = function(a, b, d) {
                var e = "^" + c(a) + " ", f = " " + c(a) + "$", g = " " + c(a) + " ", h = "^" + c(a) + "$";
                return d.replace(new RegExp(e), b + " ").replace(new RegExp(f), " " + b).replace(new RegExp(g), " " + b + " ").replace(new RegExp(h), b);
            }, g = 0; g < d.length; g++) {
                var h = d[g], i = '<img alt="' + h + '" src="' + b[h] + '"/>', j = f.bind(null, h, i);
                e = e.map(j);
            }
            return e.join("\n");
        };
    }), e.factory("VideoEnhancer", function() {
        return function(a, b, c) {
            var e = /((?:https?):\/\/\S*\.(?:ogv|webm))/gi, f = d(b, c), g = "<video " + f + 'src="$1" controls preload="none"></video>';
            return a.replace(e, g);
        };
    }), e.factory("YouTubeEnhancer", function() {
        return function(a, b, c) {
            var e = /https?:\/\/(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube\.com(?:\/embed\/|\/v\/|\/watch\?v=|\/ytscreeningroom\?v=|\/feeds\/api\/videos\/|\/user\S*[^\w\-\s]|\S*[^\w\-\s]))([\w\-]{11})[?=&+%\w-]*/gi, f = d(b, c), g = "<iframe " + f + 'src="https://www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>';
            return a.replace(e, g);
        };
    });
}(angular, void 0), function(I, d, B) {
    "use strict";
    function D(f, q) {
...
}(window, window.angular), function(n, h, p) {
    "use strict";
    function E(a) {
        var d = [];
    ...
    function F(a, d) {
        function c(a, b, c, l) {
            if (b = h.lowercase(b), t[b]) for (;f.last() && u[f.last()]; ) e("", f.last());
        ...
        function e(a, b) {
            var e, c = 0;
            if (b = h.lowercase(b)) for (c = f.length - 1; c >= 0 && f[c] != b; c--) ;
            if (c >= 0) {
        ...
        for (f.last = function() {
            ...
            if (l = "", k = !0, f.last() && x[f.last()] ? (a = a.replace(new RegExp("([\\W\\w]*)<\\s*\\/\\s*" + f.last() + "[^>]*>", "i"), function(a, b) {
            ...
            a = a.substring(b + 3), k = !1)) : y.test(a) ? (b = a.match(y)) && (a = a.replace(b[0], ""), 
            k = !1) : J.test(a) ? (b = a.match(z)) && (a = a.substring(b[0].length), b[0].replace(z, e), 
            k = !1) : K.test(a) && ((b = a.match(A)) ? (b[4] && (a = a.substring(b[0].length), 
            b[0].replace(A, c)), k = !1) : (l += "<", a = a.substring(1))), k && (b = a.indexOf("<"), 
            l += 0 > b ? a : a.substring(0, b), a = 0 > b ? "" : a.substring(b), d.chars && d.chars(r(l)))), 
            a == m) throw L("badparse", a);
            m = a;
        }
        e();
    }
    function r(a) {
        ...
        a = d[1];
        var c = d[3];
        return (d = d[2]) && (q.innerHTML = d.replace(/</g, "&lt;"), d = "textContent" in q ? q.textContent : q.innerText), 
        a + d + c;
    }
    function B(a) {
    ...
    h.module("ngSanitize", []).provider("$sanitize", function() {
        ...
        return function(e, b) {
            ...
            function f(a, c) {
                g.push("<a "), h.isDefined(b) && g.push('target="', b, '" '), g.push('href="', a.replace(/"/g, "&quot;"), '">'), 
                k(c), g.push("</a>");
            }
            if (!e) return e;
            for (var m, n, p, l = e, g = []; m = l.match(d); ) n = m[0], m[2] || m[4] || (n = (m[3] ? "http://" : "mailto:") + n), 
            p = m.index, k(l.substr(0, p)), f(n, m[0].replace(c, "")), l = l.substring(p + m[0].length);
            return k(l), a(g.join(""));
        };
    } ]);
...
!function(a, b, c) {
    ...
    H = function() {
        var a, b, c, d, e, f;
        for (d = [ "t", "webkitT", "MozT", "msT", "OT" ], a = e = 0, f = d.length; f > e; a = ++e) if (c = d[a], 
        b = d[a] + "ransform", b in F) return d[a].substr(0, d[a].length - 1);
        return !1;
    }(), G = function(a) {
            ...
            this.events = {
                ...
                drag: function(a) {
                    return function(b) {
                        ...
                        a.scroll(), a.contentScrollTop >= a.maxScrollTop && a.prevScrollTop !== a.maxScrollTop ? a.$el.trigger("scrollend") : 0 === a.contentScrollTop && 0 !== a.prevScrollTop && a.$el.trigger("scrolltop"), 
                        !1;
                    };
                }(this),
                up: function(a) {
                ...
                wheel: function(a) {
                    return function(b) {
                        var c;
                        return null != b ? (c = b.delta || b.wheelDelta || b.originalEvent && b.originalEvent.wheelDelta || -b.detail || b.originalEvent && -b.originalEvent.detail, 
                        c && (a.sliderY += -c / 3), a.scroll(), !1) : void 0;
                    };
                }(this),
                enter: function(a) {
                    return function(b) {
                        var c;
                        return a.isBeingDragged && 1 !== (b.buttons || b.which) ? (c = a.events)[w].apply(c, arguments) : void 0;
                    };
                }(this)
            };
