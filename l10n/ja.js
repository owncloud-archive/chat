OC.L10N.register(
    ...
    "Files attached to this conversation" : "この会話に添付されてるファイル",
    "Download " : "ダウンロード",
    ...
    "With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." : "'OHC'バックエンドで他のownCloudユーザーとチャットができます。これは設定なしで動作します。",
    "It can be enabled by running the following command in the root of your ownCloud installation:" : "インストールしたownCloudに対してrootディレクトリで次のコマンドを実行することで有効化が可能です:",
