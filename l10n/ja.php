...
"Files attached to this conversation" => "この会話にファイルを添付する",
"Download " => "ダウンロード",
...
"It can be enabled by running the following command in the root of your owncloud installation:" => "インストールしたownCloudに対してroot権限で次のコマンドを実行することで有効化が可能です:",
