OC.L10N.register(
    ...
    "{displayname} removed {path} from this conversation" : "{displayname} a supprimé {path} de la conversation",
    "Start a chat with ..." : "Démarrer une conversation avec…",
    ...
    "Search in users" : "Recherche parmi les utilisateurs",
    ...
    "In order to chat please create at least one user, it will appear on the left." : "Pour pouvoir lancer une discussion, veuillez créer au moins un utilisateur. Il apparaîtra sur la gauche."
},
