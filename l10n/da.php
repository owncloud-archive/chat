...
"There are no Chat Backends enabled." => "Der er ikke slået chat-backend'er til.",
"In order to chat please enable at least one Chat backend." => "For at chatte, så skal der mindst være slået én chat-backend til.",
"With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." => "Med \"OCH\"-backend'en kan du chatte med andre ownCloud-brugere. Den fungerer uden konfiguration.",
