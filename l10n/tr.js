OC.L10N.register(
    ...
    "There are no Chat Backends enabled." : "Etkin Sohbet Arka Ucu yok.",
    "In order to chat please enable at least one Chat backend." : "Sohbeti kullanabilmek için için lütfen en az bir sohbet arka ucu etkinleştirin.",
    "With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." : "'OCH' arka ucu ile diğer ownCloud kullanıcıları ile sohbet edebilirsiniz. Yapılandırma olmadan çalışır.",
    "It can be enabled by running the following command in the root of your owncloud installation:" : "ownCloud kurulumunuzun kök dizininde aşağıdaki komut çalıştırarak etkinleştirilebilir:",
