...
"There are no Chat Backends enabled." => "Keskustelutaustaosia ei ole käytössä.",
"In order to chat please enable at least one Chat backend." => "Jotta keskustelun käyttäminen on mahdollista, ota käyttöön vähintään yksi keskustelutaustaosa.",
"With the 'OCH' backend you can chat with other ownCloud users. It works without configuration." => "OCH-taustaosalla voi keskustella muiden ownCloud-käyttäjien kanssa. Se toimii ilman erillisiä määrityksiä.",
"It can be enabled by running the following command in the root of your owncloud installation:" => "Sen voi ottaa käyttöön suorittamalla seuraavan komennon ownCloud-asennuksen juurihakemistossa:",
